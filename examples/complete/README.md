...
| <a name="input_security_group_ingress_config"></a> [security\_group\_ingress\_config](#input\_security\_group\_ingress\_config) | Incoming traffic configuration for the rds security group | `any` | <pre>[<br>  {<br>    "cidr_blocks": [<br>      "0.0.0.0/0"<br>    ],<br>    "description": "inbound rds traffic",<br>    "from_port": 3306,<br>    "protocol": "tcp",<br>    "to_port": 3306<br>  }<br>]</pre> | no |
