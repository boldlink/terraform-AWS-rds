...
# Terraform module usage example with oracle db configuration
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_rds_instance_oracle"></a> [rds\_instance\_oracle](#module\_rds\_instance\_oracle) | ../../ | n/a |
...
| <a name="input_engine_version"></a> [engine\_version](#input\_engine\_version) | Specify the version of the engine for this db | `string` | `"19.0.0.0.ru-2022-01.rur-2022-01.r1"` | no |
| <a name="input_identifier"></a> [identifier](#input\_identifier) | (Optional) The name of the RDS instance, if omitted, Terraform will assign a random, unique identifier. Required if restore\_to\_point\_in\_time is specified. | `string` | `"exampleinstanceoracle"` | no |
...
| <a name="input_major_engine_version"></a> [major\_engine\_version](#input\_major\_engine\_version) | Specify the major version of the engine that this option group should be associated with. | `string` | `"19"` | no |
...
| <a name="input_port"></a> [port](#input\_port) | Port through which db accepts traffic | `number` | `1521` | no |
