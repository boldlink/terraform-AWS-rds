...
# Terraform module usage example with configuration for oracle
...
| Name | Description |
|------|-------------|
| <a name="output_address"></a> [address](#output\_address) | Values for resources created by the module |
